...
type TabType = 'accounts' | 'activity';
        ...
        <div className="admin-layout">
                ...
                <div>
                    ...
                    <div className="page-header">
                        <div>
                            ...
                            <p className="page-subtitle">Manage auth system accounts and permissions</p>
                        </div>
                        ...
                        {loading ? (
                                                ...
                                                <div key={staff.id} className="table-row" onClick={() => openViewModal(staff)}>
                                                    ...
                                                    <div>
                                                        <span className="authority-badge" style={{ 
                                                            background: `${auth.color}20`,
                                                            color: auth.color,
                                                            borderColor: `${auth.color}40`
                                                        }}>
                                                            {auth.label}
                                                        </span>
                                                    </div>
                                                    ...
                                                    <div className="actions-cell" onClick={e => e.stopPropagation()}>
                                                        <button className="action-btn" title="Edit" onClick={() => openEditModal(staff)}>
                                                            <Icons.Edit />
                                                        </button>
                                                        <button 
                                                            className={`action-btn ${staff.enabled ? 'danger' : 'success'}`}
                                                            title={staff.enabled ? 'Disable' : 'Enable'}
                            ...
                            <div className="card">
                                <div className="empty-state">
                                    ...
                                    <span>Track staff logins, actions, and activity</span>
                                </div>
                            </div>
                        )}
                    </div>
                                ...
                                <div className="form-grid">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input
                                            ...
                                            placeholder={modalType === 'create' ? 'Enter password' : '••••••••'}
                                        />
                                    </div>
            ...
            <style jsx>{`
                ...
                .table-header, .table-row {
                    display: grid;
                    grid-template-columns: 2fr 1fr 1.5fr 1fr 1fr 100px;
                    align-items: center;
                    padding: 12px 24px;
                    gap: 16px;
                }
                ...
                .perm-badge { padding: 4px 10px; background: var(--bg-hover); border-radius: 4px; font-size: 11px; color: var(--text-secondary); font-family: var(--font-mono); }
